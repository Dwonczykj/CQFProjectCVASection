...
from Returns import AIC
import os
import time

SubmissionFilePath= os.path.join('C:\\', 'Users', 'Joe.Dwonczyk', 'Documents', 'CQF', 'CVASection', 'Submission') + "\\CVA\\" + time.strftime("%Y%m%d-%H%M%S") + "\\"
